...
config :hex_hub, :clustering,
  ...
  heartbeat: %{
    enabled: true,
    interval: String.to_integer(System.get_env("HEARTBEAT_INTERVAL") || "5000"), # 5 seconds
    timeout: String.to_integer(System.get_env("HEARTBEAT_TIMEOUT") || "10000")   # 10 seconds
  }
