defmodule HexHub.MCP.Tools do
  ...
  def register_all_tools do
    tools = %{
      ...
      "get_package_metadata" => register_tool("get_package_metadata", &get_package_metadata_handler/2),
      ...
      "list_documentation_versions" => register_tool("list_documentation_versions", &list_documentation_versions_handler/2),
      "search_documentation" => register_tool("search_documentation", &search_documentation_handler/2),

      # Dependency resolution tools
      "resolve_dependencies" => register_tool("resolve_dependencies", &resolve_dependencies_handler/2),
      "get_dependency_tree" => register_tool("get_dependency_tree", &get_dependency_tree_handler/2),
      "check_compatibility" => register_tool("check_compatibility", &check_compatibility_handler/2),

      # Repository management tools
      "list_repositories" => register_tool("list_repositories", &list_repositories_handler/2),
      "get_repository_info" => register_tool("get_repository_info", &get_repository_info_handler/2),
      "toggle_package_visibility" => register_tool("toggle_package_visibility", &toggle_package_visibility_handler/2)
    }
  ...
  defp get_tool_spec("list_releases") do
    {
      ...
      HexHub.MCP.Schemas.build_tool_schema([
        name: [type: :string, required: true, description: "Package name"],
        include_retired: [type: :boolean, required: false, description: "Include retired versions"]
      ])
    }
  end
  ...
  defp get_tool_spec("list_repositories") do
    {
      ...
      HexHub.MCP.Schemas.build_tool_schema([
        include_private: [type: :boolean, required: false, description: "Include private repositories"]
      ])
    }
  end
  ...
  defp search_packages_handler(args, _context), do: HexHub.MCP.Tools.Packages.search_packages(args)
  ...
  defp get_package_metadata_handler(args, _context), do: HexHub.MCP.Tools.Packages.get_package_metadata(args)
  ...
  defp download_release_handler(args, _context), do: HexHub.MCP.Tools.Releases.download_release(args)
  defp compare_releases_handler(args, _context), do: HexHub.MCP.Tools.Releases.compare_releases(args)

  defp get_documentation_handler(args, _context), do: HexHub.MCP.Tools.Documentation.get_documentation(args)
  defp list_documentation_versions_handler(args, _context), do: HexHub.MCP.Tools.Documentation.list_documentation_versions(args)
  defp search_documentation_handler(args, _context), do: HexHub.MCP.Tools.Documentation.search_documentation(args)

  defp resolve_dependencies_handler(args, _context), do: HexHub.MCP.Tools.Dependencies.resolve_dependencies(args)
  defp get_dependency_tree_handler(args, _context), do: HexHub.MCP.Tools.Dependencies.get_dependency_tree(args)
  defp check_compatibility_handler(args, _context), do: HexHub.MCP.Tools.Dependencies.check_compatibility(args)

  defp list_repositories_handler(args, _context), do: HexHub.MCP.Tools.Repositories.list_repositories(args)
  defp get_repository_info_handler(args, _context), do: HexHub.MCP.Tools.Repositories.get_repository_info(args)
  defp toggle_package_visibility_handler(args, _context), do: HexHub.MCP.Tools.Repositories.toggle_package_visibility(args)
end